<template>
  ...
  <el-form label-position="right" :model="formLabelAlign" status-icon :rules="rules"
    ...
    <el-form-item label="姓名" prop="name">
      <el-input v-model="formLabelAlign.name" placeholder="请填写收件人姓名" prefix-icon="el-icon-s-custom"></el-input>
    </el-form-item>
    ...
    <el-form-item class="nextone">
      <el-button type="primary" style="margin-top: 5px" @click="next('receiveForm')">下一步 <i class="el-icon-right"></i></el-button>
    </el-form-item>
  </el-form>
</template>
